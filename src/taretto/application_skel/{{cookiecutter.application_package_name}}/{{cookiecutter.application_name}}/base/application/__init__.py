...
from {{cookiecutter.application_name}}.base.application.implementations import ImplementationContext
...
class Application(object):
    ...
    def __init__(self, hostname, path="", scheme="https"):
        ...
        self.collections = EntityCollections.for_application(self, self.load_application_collections())
